...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img1, "class", "svelte-1f8pwqt");
    			add_location(img1, file$3, 152, 20, 7277);
    			attr_dev(button1, "onclick", "this.blur();");
    			attr_dev(button1, "class", "but svelte-1f8pwqt");
    			attr_dev(button1, "id", "yes");
    			add_location(button1, file$3, 151, 16, 7158);
    			attr_dev(div2, "class", "yes-block svelte-1f8pwqt");
    			add_location(div2, file$3, 150, 12, 7118);
    			attr_dev(div3, "class", "yes-no-buttons svelte-1f8pwqt");
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$set = $$props => {
    		if ("finish" in $$props) $$invalidate(5, finish = $$props.finish);
    	};
    	...
    	return [currIndex, fonds, renderNextFond, likeFond, viewDescription, finish];
    }

    class Main extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { finish: 5 });
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-xnh5ri");
    			add_location(img, file$5, 15, 0, 182);
    			attr_dev(h1, "class", "svelte-xnh5ri");
    			...
    			attr_dev(button, "class", "reset svelte-xnh5ri");
    			add_location(button, file$5, 26, 12, 790);
    			attr_dev(div1, "class", "reset-but svelte-xnh5ri");
    			add_location(div1, file$5, 25, 8, 754);
    			attr_dev(div2, "class", "yes-no-buttons svelte-xnh5ri");
